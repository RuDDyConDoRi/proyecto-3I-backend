...
/**
 * Persistent class for entity stored in table "soljuzgado"
 *
...
@Entity
@Table(name="soljuzgado", catalog="plaproc" )
// Define named queries here
@NamedQueries ( {
  @NamedQuery ( name="SolJuzgado.countAll", query="SELECT COUNT(x) FROM SolJuzgado x" )
} )
public class SolJuzgado implements Serializable {

...
/**
 * Persistent class for entity stored in table "continuacion"
 *
...
@Entity
@Table(name="continuacion", catalog="plaproc" )
// Define named queries here
@NamedQueries ( {
  @NamedQuery ( name="Continuacion.countAll", query="SELECT COUNT(x) FROM Continuacion x" )
} )
public class Continuacion implements Serializable {

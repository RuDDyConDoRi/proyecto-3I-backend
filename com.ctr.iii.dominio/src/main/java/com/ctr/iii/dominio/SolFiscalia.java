...
/**
 * Persistent class for entity stored in table "solfiscalia"
 *
...
@Entity
@Table(name="solfiscalia", catalog="plaproc" )
// Define named queries here
@NamedQueries ( {
  @NamedQuery ( name="SolFiscalia.countAll", query="SELECT COUNT(x) FROM SolFiscalia x" )
} )
public class SolFiscalia implements Serializable {
